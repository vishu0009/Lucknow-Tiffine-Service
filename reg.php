...
<body>
    <div class="container">
        <header>Registration 
            <a href="index.php" style="border: 1px solid black; padding: 10px; border-radius: 7px; text-decoration: none; margin-left: 500px;">Go to Login</a>
        </header>
                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="cardno" placeholder="Enter Card Number" required>
                        </div>
                        ...
                        <div class="input-field">
                            <label>CVV</label>
                            <input type="text" name="cvv" placeholder="Enter Card's CVV" required>
                        </div>
...
$sql="insert into `reg`(`name`,pass, cpass, `dob`, `email`, `mobile`, `gen`, `addr`, `card`, `cardno`, `cvv`) values ('$n','$pass','$cpass', '$dob','$email','$mob','$gen','$addr','$card','$cardno','$cvv')";
